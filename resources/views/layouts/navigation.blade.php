    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden md:flex items-center justify-center flex-1">
                <div class="flex space-x-1">
                    ...
                    @else
                        ...
                        <a href="#about-company" class="px-4 py-2 text-blue-600 hover:text-blue-800 hover:bg-blue-50 rounded-md transition duration-150 ease-in-out">Company Profile</a>
                        <a href="#company-detail" class="px-4 py-2 text-blue-600 hover:text-blue-800 hover:bg-blue-50 rounded-md transition duration-150 ease-in-out">ALMA Company Profile</a>
            ...
            <div class="hidden md:flex items-center">
                ...
                @else
                    <a href="{{ route('login') }}" class="px-5 py-2 text-white bg-blue-600 hover:bg-blue-700 rounded-md transition duration-150 ease-in-out">Admin</a>
                @endauth
            </div>
    ...
    <div class="hidden md:hidden absolute w-full bg-white shadow-lg rounded-b-lg" id="mobile-menu">
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            @else
                ...
                <a href="#about-company" class="block px-4 py-3 text-blue-600 hover:text-blue-800 hover:bg-blue-50 rounded-md transition duration-150 ease-in-out">Company Profile</a>
                <a href="#company-detail" class="block px-4 py-3 text-blue-600 hover:text-blue-800 hover:bg-blue-50 rounded-md transition duration-150 ease-in-out">ALMA Company Profile</a>
