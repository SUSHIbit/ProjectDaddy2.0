            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('admin.dashboard') }}">
                        <!-- Fixed Company Logo with fallback -->
                        @if(isset($settings['company_logo']) && !empty($settings['company_logo']))
                            <img src="{{ asset($settings['company_logo']) }}" alt="Company Logo" class="h-10 w-auto">
                        @else
                            <!-- Fallback to a placeholder logo if no logo is found -->
                            <div class="h-10 flex items-center justify-center bg-blue-600 px-3 rounded-md text-white font-bold">
                                {{ substr(config('app.name', 'LOGO'), 0, 1) }}
                            </div>
                        @endif
                    </a>
                </div>
